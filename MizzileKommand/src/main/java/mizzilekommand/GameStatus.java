...
public class GameStatus {
    ...
    /**
     * This method marks a city as destroyed. It also increments the number of cities
     * destroyed in the current level.
    ...
    /**
     * This method tells whether enough cities were destroyed for the current level.
     * @return true if enough cities were destroyed for the current level. The threshold
     * is 3. False if less than 3 cities were destroyed.
     */
    ...
    /**
     * This method returns true if the city with the id given as parameter is not destroyed
    ...
    /**
     * This method returns true if any incoming missiles are left in the current level
    ...
    /**
     * This method subtracts 1 from the amount of incoming missiles left in the current level
     */
