 ...
 * classes. It provides the common functionality and properties for the
 * actual scene classes.
...
public abstract class SceneTemplate extends Scene {
    ...
    /**
     * This is a convenience methos to get a reference to the Scene root.
